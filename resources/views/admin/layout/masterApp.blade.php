			...
			<div class="container-fluid side-bar-container">
				<header class="pb-0">
					<a class="navbar-brand">
						<object class="side-logo" data="{{ asset('admin/svg/logo-8.svg')}}" type="{{ asset('admin/image/svg+xml')}}">
						</object>
					</a>
				</header>
				...
				<ul class="side a-collapse ">
					...
					<div class="side-item-container ">
						<li class="side-item {{ request()->routeIs('dashboard.index') ? 'selected' : '' }}">
							<a href="{{ route('dashboard.index') }}"><i class="fas fa-angle-right mr-2"></i>Dashboard</a>
						</li>	
						...
						<li class="side-item {{ request()->routeIs('projects.index') ? 'selected' : '' }}">
							<a href="{{ route('projects.index') }}"><i class="fas fa-angle-right mr-2"></i>Projects</a>
						</li>
						<li class="side-item {{ request()->routeIs('jobsTitles.index') ? 'selected' : '' }}">
							<a href="{{ route('jobsTitles.index') }}"><i class="fas fa-angle-right mr-2"></i>Job Titles</a>
						</li>
						...
						<li class="side-item {{ request()->routeIs('languages.index') ? 'selected' : '' }}">
							<a href="{{ route('languages.index') }}"><i class="fas fa-angle-right mr-2"></i>Languages</a>
						</li>
