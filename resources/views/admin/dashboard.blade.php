...
<div class="row m-1 mb-2">
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card mini animate__animated animate__flipInY   "><i
            ...
            <span class="c-first">Projects</span>
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card mini animate__animated animate__flipInY    "><i
            ...
            <span class="c-second">Skills</span>
            <span>{{ $skillCount }}</span>
            <p class="mt-3 mb-1 text-center"><i class="far fas fa-wifi mr-1 c-second"></i>Your main skills in your CV</p>
        </div>
    </div>
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card mini animate__animated animate__flipInY   "><i
                class="fab far fa-comments b-third" aria-hidden="true"></i>
            <span class="c-third">Job Title</span>
            <span>{{ $jobTitleCount }}</span>
            <p class="mt-3 mb-1 text-center"><i class="fab fa-whatsapp mr-1 c-third"></i>Your main Job Title in your CV</p>
        </div>
    </div>
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card mini animate__animated animate__flipInY   "><i
                class="fab far fa-gem b-forth" aria-hidden="true"></i>
            <span class="c-forth">Languages</span>
            <span>{{ $languageCount }}</span>
            <p class="mt-3 mb-1 text-center"><i class="fab fa-bluetooth mr-1 c-forth"></i>Your main Languages</p>
        </div>
    </div>
</div>
            ...
            <div class="">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="card-body">
                        ...
                        tempor, sunt aliqua put a bird on it squid single-origin coffee null a
